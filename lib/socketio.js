        ...
        socket.on('submitClicked', function(msg, respond) {
            ...
            async.waterfall([
                function(callback) {
                    ...
                    request({url: url.parse(index), headers: {'Accept': '*/*', 'User-Agent': 'curl/7.40.0'}}, function (err, response, html) {
                        if(err != null) {
                ...
                function(html, callback) {
                    ...
                    if (nextUsed && requestVal > 1) {
                        ...
                        async.doUntil(function(callback2) {
                            ...
                            setTimeout(function() {
                                request({url: url.parse(fetchMe), headers: {'Accept': '*/*', 'User-Agent': 'curl/7.40.0'}}, function (err, response, body) {
                                    if(err != null) {
